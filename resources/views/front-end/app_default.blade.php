				...
				<nav class="limiter-menu-desktop container">
					...
					<div class="wrap-icon-header flex-w flex-r-m">
						...
						<a class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 js-show-cart" href="{{route('cart.index')}}" >
							...
							<span style="font-family: Poppins-Regular; font-size: 12px; color: #fff; line-height: 15px; text-align: center; display: block; position: absolute; top: -7px; right: 0; min-width: 15px; height: 15px; padding: 0 3px; background-color: #717fe0;" id="total_quantity">{{$total_quantity}}</span>
						</a>
					</div>
				</nav>
			</div>	
